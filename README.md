...
npm install
Configura las variables de entorno: Copia el archivo .env.example a .env y configura las variables necesarias:
...
Instala las dependencias:
npm install
Configura las variables de entorno: Crea un archivo .env.local con:
...
Inicia el frontend con npm run dev en el directorio frontend/client
...
Despliegue
Frontend
El frontend está desplegado en Vercel y se puede acceder en: https://ecuatechnology.vercel.app/
...
Backend
El backend debe desplegarse en un servidor separado (ej: Heroku, Railway, VPS). Requiere configuración de base de datos SQL Server en producción.
